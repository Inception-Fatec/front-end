            ...
            <div className="flex-1 space-y-1.5">
              ...
              <div className="flex items-center rounded-lg border border-border bg-background focus-within:border-primary transition-colors">
                <input
                  ...
                  placeholder="Ex: 30"
                  className="flex-1 px-3 py-2 bg-transparent text-sm text-foreground placeholder:text-secondary-text focus:outline-none"
                />
                {parameterType?.symbol && (
                  <span className="shrink-0 px-3 py-2 text-xs text-secondary-text border-l border-border">
                    {parameterType.symbol}
                  </span>
                )}
              </div>
