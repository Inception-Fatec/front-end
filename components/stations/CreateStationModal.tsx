...
export function CreateStationModal({
    ...
    const [idDatalogger, setIdDatalogger] = useState("");
    ...
    async function handleSubmit() {
        ...
        if (!name.trim() || !idDatalogger.trim()) {
            return setError("Nome e ID do datalogger são obrigatórios.");
        }
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm p-4">
            <div className="w-full max-w-md bg-card-background border border-border rounded-xl shadow-2xl max-h-[90vh] flex flex-col">
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-border shrink-0">
                    <h2 className="text-sm font-semibold text-foreground">Nova Estação</h2>
                    <button
                        onClick={onClose}
                ...
                <div className="px-6 py-5 space-y-4 overflow-y-auto">
                    ...
                    <div className="space-y-1.5">
                        ...
                        <input
                            ...
                            placeholder="Ex: Estação Norte SP"
                    ...
                    <div className="flex items-center justify-between py-1">
                        <div>
                            ...
                            <p className="text-[11px] text-secondary-text">
                                Permitir recepção de dados imediatamente
                            </p>
                        </div>
                        <button
