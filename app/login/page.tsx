            ...
            <div className="bg-background flex justify-center items-center w-full lg:w-1/3">
                <div className="bg-transparent flex flex-col items-center w-full max-w-md px-12">
                    ...
                    <form onSubmit={handleSubmit} className="w-full space-y-6">
                        ...
                        <button type="submit" className="bg-primary flex flex-row justify-center items-center gap-2 w-full h-12 font-bold rounded-[0.475rem] hover:cursor-pointer">
                            Entrar<ArrowRight />
                        </button>
                    </form>
                    <div className="mt-10 flex flex-col items-center gap-4">
                        ...
                        <p className="text-sm text-secondary-text">Apenas usuários autorizados.</p>
                    </div>
                </div>
            </div>
        </main>
